...
<head>
	<meta charset="UTF-8">
	<title>Preview - Lovely Cosmetics Responsive HTML Template</title>
	<!-- Stylesheets -->
...
<div class="section"> 
	<div class="line">
		<div class="margin">
			...
			<img src="img/products/large.png" alt="">
			</div>
			<!-- product detail -->
			<div class="s-12 m-8 l-7 padding-l-left">
				<h2 class="text-primary">Lorem Ipsum Dolor Amet</h2>
				<p>
		...
		<div class="fullwidth">
			<div class="tabs left">
				<div class="tab-item tab-active">
					<a class="tab-label active-btn">Description</a>
